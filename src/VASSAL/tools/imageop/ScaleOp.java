 ...
 */
public class ScaleOp extends AbstractTiledOp {
   ...
   */
  public ScaleOp(ImageOp sop, double scale) {
    this(sop, scale, null);
  }
   ...
   */
  public ScaleOp(ImageOp sop, double scale, RenderingHints hints) {
