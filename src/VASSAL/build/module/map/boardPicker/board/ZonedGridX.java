 ...
 */
public class ZonedGridX extends AbstractConfigurable implements GeometricGrid, GridContainer {
...
//    return container.getSize();
  ...
  public Zone findZone(@SuppressWarnings("hiding") String name) {
    for (Zone zone : zones) {
  ...
  public ZoneHighlight getZoneHighlight(@SuppressWarnings("hiding") String name) {
