 ...
 *
 */
public class HexGridX extends AbstractUIHexGrid implements GameComponent {
  CHIFactory chif;
   ...
   */
  @Override
  public void drawCatchBuckets(Graphics g, Rectangle bounds, Rectangle visibleRect, double zoom, boolean reversed) {
    if (cornersLegal) {
      gridHexVertexBuckets.forceDraw(g, bounds, visibleRect, zoom, reversed);
    }
    if (edgesLegal) {
      gridHexSideBuckets.forceDraw(g, bounds, visibleRect, zoom, reversed);
    }
  }
