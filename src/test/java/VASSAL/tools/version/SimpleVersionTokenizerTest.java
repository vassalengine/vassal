...
public class SimpleVersionTokenizerTest {
  ...
  public SimpleVersionTokenizerTest(String inputVersionString, Object[] expectedResult) {
  ...
  public static Collection<Object[]> testData() {
    return Arrays.asList(new Object[][]{
      ...
      { "1.2.3-svn7890", new Object[] { 1, 2, 3, null }},
      { "1.2.3-beta5",   new Object[] { 1, 2, 3, null }},
      { "1.2.3-rc3",     new Object[] { 1, 2, 3, null }},
      { "foobarbaz",     new Object[] { null          }},
      { "1.2.foo",       new Object[] { 1, 2, null    }},
      { "1.2-foo",       new Object[] { 1, 2, null    }},
      { "1.2-svn1234.8", new Object[] { 1, 2, null    }},
  ...
  public void testTokenizer() throws VersionFormatException {
    final SimpleVersionTokenizer tok = new SimpleVersionTokenizer(inputVersionString);
