...
* [ ] Post release announcements (see `tmp/notes-*`):
  ...
  * Our forum: http://www.vassalengine.org/forum/viewforum.php?f=2 (Set the new post to be an Announcement; also set the previous release's post to be a Normal post again.)
