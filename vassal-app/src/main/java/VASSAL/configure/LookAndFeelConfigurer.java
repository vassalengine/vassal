...
public class LookAndFeelConfigurer extends Configurer {
  ...
  public static class Info extends LookAndFeelInfo {
    ...
    protected void updateLnF() {
      try {
        ...
        if (isMetal) {
          if (properties != null) {
            System.out.print("Theme is Metal with properties " + properties);
   ...
   */
  public final void updateLookAndFeels() {
  ...
  public java.awt.Component getControls() {
    ...
    for (final String key : keys) {
      ...
      laf.addItem(info);
      if (value != null &&
          getInfo().getName().equals(info.getName())) {
        current = info;
      }
      if (info.getClassName().equals(sysClsName)) {
        sysInfo = info;
      }
    }
  ...
  public static void main(String[] args) {
    ...
    config.addPropertyChangeListener(evt -> {
      final LookAndFeelConfigurer fconfig
        = new LookAndFeelConfigurer(null, null);
