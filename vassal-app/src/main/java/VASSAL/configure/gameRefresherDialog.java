...
public class gameRefresherDialog extends JDialog {
  ...
  public gameRefresherDialog(Frame owner) throws HeadlessException {
    super(owner, false);
    setTitle(Resources.getString("Editor.gameRefresherDialog.title"));
    initComponents();
    fc = new JFileChooser();
