...
public class BeanShellFunctionMenu extends JPopupMenu {
  ...
  public BeanShellFunctionMenu(EditablePiece target, BeanShellExpressionConfigurer configurer) {
    ...
    addFunction(propMenu, "GetAttachmentProperty", Resources.getString("Editor.BeanShell.getattachmentproperty"), new String[] { Resources.getString("Editor.BeanShell.attachment_name"), Resources.getString("Editor.BeanShell.property_name"), Resources.getString("Editor.BeanShell.index_name") }, "(attachment, prop, index)"); //NON-NLS
    ...
    addFunction(countMenu, "SumAttachment", Resources.getString("Editor.BeanShell.sum10"), new String[] { Resources.getString("Editor.BeanShell.attachment_name"), Resources.getString("Editor.BeanShell.property_name") }, "(attachment, propname)"); //NON-NLS
    addFunction(countMenu, "CountAttachment", Resources.getString("Editor.BeanShell.sum11"), new String[] { Resources.getString("Editor.BeanShell.attachment_name"), Resources.getString("Editor.BeanShell.property_name") }, "(attachment, propname)"); //NON-NLS
