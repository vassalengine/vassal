...
public class PieceMover extends AbstractBuildable
  ...
  protected void performDrop(Point p) {
    ...
    // Pause logging to capture any Commands generated by the drop (e.g. Deck Empty Hotkeys) and
    // append them to move commands. This ensures a single undo for a drag and drop.
    final GameModule gm = GameModule.getGameModule();
    gm.pauseLogging();
    Command move = movePieces(map, p);
    move = move.append(gm.resumeLogging());
