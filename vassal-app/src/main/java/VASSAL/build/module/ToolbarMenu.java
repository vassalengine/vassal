...
public class ToolbarMenu extends AbstractToolbarItem
  ...
  @Deprecated public static final String BUTTON_TEXT = "text"; //$NON-NLS-1$
  @Deprecated public static final String BUTTON_ICON = "icon"; //$NON-NLS-1$
  @Deprecated public static final String BUTTON_HOTKEY = "hotkey"; //$NON-NLS-1$
