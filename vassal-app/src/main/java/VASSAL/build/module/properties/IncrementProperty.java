...
public class IncrementProperty implements PropertyChanger {
  ...
  public String getNewValue(String oldValue) {
    ...
    try {
      ...
      ErrorDialog.dataWarning(new BadDataReport(Resources.getString("Error.non_number_error"), "Increment "+prop.getName()+": format="+format.getFormat()+", value="+format.getText(constraints), e));
      return oldValue;
    }
  }
