  ...
  public void mySetState(String state) {
    if (validAngles.length == 1) {
      try {
        ...
        reportdataWarning(this, Resources.getString("Error.non_number_error"), "Angle="+state, e);
      }
    }
    else {
      try {
        ...
        reportdataWarning(this, Resources.getString("Error.non_number_error"), "Fixed Angle Index="+state, e);
      }
    }
  }
