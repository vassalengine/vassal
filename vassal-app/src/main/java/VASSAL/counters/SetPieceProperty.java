 ...
 * Uses the Property manipulation functionality of DynamicProperty
 */
public class SetPieceProperty extends DynamicProperty {
  ...
  private final SetPiecePropertySource propertiesWithIndex = new SetPiecePropertySource();
  private int index = 0;
  private String currentBasicName = "";
  private String currentAttachmentName = "";
  private final SetPieceProperty This = this; // So our property source thing can report our identity downstream
   ...
   */
  public class SetPiecePropertySource implements PropertySource {
    @Override
  ...
  public Command myKeyEvent(KeyStroke stroke) {
    ...
    for (final DynamicKeyCommand keyCommand : keyCommands) {
      if (keyCommand.matches(stroke)) {
        ...
        String attachmentName = (new FormattedString(attachName)).getText(propertiesWithIndex, this, "Editor.SetPieceProperty.attachment_name");
        ...
        String attachmentIndex = (new FormattedString(attachIndex)).getText(propertiesWithIndex, this, "Editor.SetPieceProperty.attachment_index");
        ...
        while (p instanceof Decorator) {
          if (p instanceof Attachment) {
            ...
            if (attachmentName.isBlank() || attachmentName.equals(attachment.getAttachName())) {
              ...
              attachmentName = (new FormattedString(attachName)).getText(propertiesWithIndex, this, "Editor.SetPieceProperty.attachment_name");
              ...
              for (final GamePiece propPiece : attachment.getAttachList()) {
                ...
                if (!attachmentIndex.isBlank()) {
                  if (NumberUtils.isParsable(attachmentIndex)) {
                    ...
                    attachmentIndex = (new FormattedString(attachIndex)).getText(propertiesWithIndex, this, "Editor.SetPieceProperty.attachment_index");
