...
There are several hundred game modules located at http://www.vassalengine.org/modules[[.underline]#http://www.vassalengine.org/modules#]. Individual creators have provided these modules for you to play free of charge.
...
Visit the http://www.vassalengine.org/forums[[.underline]#Vassal forums#] for more information.
