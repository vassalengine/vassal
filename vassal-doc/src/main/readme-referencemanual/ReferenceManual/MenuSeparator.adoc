...
*If this Key Command is hidden, hide seperator:* If the specified Key Command is hidden (by a <<RestrictCommands.adoc#top,Restrict Commands>> trait), then this separator will be hidden also.
