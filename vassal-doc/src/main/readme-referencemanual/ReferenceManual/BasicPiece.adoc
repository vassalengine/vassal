...
* _StackPos_ contains the position of the piece within its current Stack, 1 being the top. If the piece is a Non-stacking piece, StackPos will return 1.

* _StackSize_ comtains the number of pieces in the its current Stack. If the piece is a Non-stacking piece, StackPos will return 1.
