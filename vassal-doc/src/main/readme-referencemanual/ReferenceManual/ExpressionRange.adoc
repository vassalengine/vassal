...
#[ Trait Only ]#
| Calculate the range in Grid Units or pixels from on X, Y position to another X, Y positiom on the current Map. +
...
| Calculate the range in Grid Units or pixels from on X, Y position to another X, Y positiom on named Map. +
