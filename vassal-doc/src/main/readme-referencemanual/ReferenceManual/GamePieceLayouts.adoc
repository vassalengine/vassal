...
*Anti-alias:*:: Turn on anti-aliasing ehen drawing the item. Can improve the look of the certain items, especially when they are small or contain narrow lines.
