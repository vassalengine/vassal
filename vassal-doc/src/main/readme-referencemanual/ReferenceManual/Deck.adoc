...
*Hot Key to send when Deck empties:*  Select the <<NamedKeyStroke.adoc#top,Keystroke Command or Named Command>> to send whenever enough cards are removed from the Deck to empty it.
...
*Send Hot Key:*  Select a <<NamedKeyStroke.adoc#top,Keystroke Command or Named Command>> that will cause the Deck contents to be moved to the target Deck.
