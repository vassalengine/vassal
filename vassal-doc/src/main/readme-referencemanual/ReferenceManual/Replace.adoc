...
*Keystroke to apply after placement:* Optional <<NamedKeyCommand.adoc#top,Ketstroke or Named Command>> to be applied automatically to the new piece immediately after being placed.
