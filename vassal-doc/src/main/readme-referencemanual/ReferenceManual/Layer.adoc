...
*Reset to level:*::  Specifies a key command that resets the Layer to a level specified by an <<Expression.adoc#top,Expression>>.

NOTE: This does _not_ automatically _activate_ the Layer.
