...
components and pieces will in turn reference <<Properties.adoc#top, Properties>> and <<Expressions.adoc#top, Expressions>> that determine how they operate. See <<#SubComponents,below>> for more details on individual types of component.
