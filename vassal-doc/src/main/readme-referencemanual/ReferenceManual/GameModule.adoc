...
As of VASSAL 3.7, a startup global _hot key_ can optionally be specified (instead of a global key command) for the purpose of directly activating toolbar buttons or deck key commands (such as automatically shuffling a deck at game start).
