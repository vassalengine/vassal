...
*Place marker:*::  Choose whether the new piece should be placed on the top of this piece's stack, on the bottom, or directly above/below the triggering piece. If an offset has been specified, the above/below options are interpreted as top and bottom respectively.
