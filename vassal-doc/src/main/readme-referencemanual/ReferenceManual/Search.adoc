...
The default scope is a simple search that targets the names and descriptions of components and pieces. Options can be used to search through all module data or to limit the search to data types of interest. Special search types offer additional flexibility.
...
===== Match names & descriptions
Match against the names and descriptions of components or pieces. Some components use Menu name or description as their name.
