...
The default search is to search for everything, but the Advanced Search options can be used to limit the type of search performed. Two special search types are offered for more flexibility.
