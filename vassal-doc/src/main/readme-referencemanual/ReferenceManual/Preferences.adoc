...
Module can also define their own preference that will appear on module specific tabs.
[#General]
==== General Preferences
...
NOTE: Use of this preference is *strongly* discouraged unless you have an old module that depend on it.
...
[width="100%",cols="50%a,50%",]
|===
|*Send Wake-up:*:: Configure the "Wake-up" sounds that is played when another player send you a "Wake-up" in an on-line room.
