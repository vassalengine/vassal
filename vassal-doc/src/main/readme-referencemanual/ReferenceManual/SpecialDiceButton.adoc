...
*Number of animation steps before result:*:: Only for animated symbolic dice. Number of animated die roll steps before the result is shown.  The images will be chosen at random between the possible die-roll outcomes and rotated to illidate rolling.
