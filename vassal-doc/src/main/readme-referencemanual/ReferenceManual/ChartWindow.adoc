...
*Preset Zoom Levels:*:: Configures a series of fractional scale factors for display of the Chart. See <<Map.adoc#top,Zoom>> for further details.

*Zoom in hotkey:*:: The key to use to zoom in on the chart.  Defaults to `Ctrl++`.

*Zoom out hotkey:*:: The key to use to zoom in on the chart. Defaults to `Ctrl+-`.

*Zoom initial hotkey:*:: The key to use to return to the initial zoom value. Defaults to `Ctrl+0`.
