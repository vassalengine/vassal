...
|*Sleep* | Sleep(ms)|{Sleep(500)} + |*Sleep* causes the screen to refresh and then pauses all screen updates for the number of milliseconds specifed. The example will 'sleep' for a 1/2 second.
