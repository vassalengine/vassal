...
public class Language extends AbstractConfigurable {
   ...
   * translated have been recorded.
   * There may be multiple translations that match this Locale, merge them
   * in order - Country over-rides Language over-rides default. 
  ...
  */
  ...
  /**
   * Called whenever a Translation is added to a module or extension. Check
   * if the translation macthes our locale. If so, add it to the list of
   * translations to use. There may multiple matching translations at Country,
   * Language and Module level from different extensions.
   * 
   * @param t Translation
   */
